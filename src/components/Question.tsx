...
export default function Question() {
    ...
    const shouldShowWarning =
        showMinAnswersWarning && !hasEnoughAnswersForResults;
    ...
    const handleOptionsKeyDown = useCallback(
        (event: React.KeyboardEvent<HTMLDivElement>) => {
            ...
            const options = Array.from(
                optionsGrid.querySelectorAll<HTMLButtonElement>(
        ...
        return (
            <div className="question-page">
                ...
                >
                    ...
                    >
                        Das Quiz wurde noch nicht gestartet oder die Sitzung ist
                        abgelaufen. Bitte starte das Quiz von der Startseite
                        aus.
                    </p>
                    <motion.button
                ...
                {shouldShowWarning && (
                    ...
                    >
                        ...
                        <div className="warning-content">
                            ...
                            <p>
                                Du hast erst {answeredCount}{' '}
                                {answeredCount === 1 ? 'Frage' : 'Fragen'}{' '}
                                beantwortet. Beantworte mindestens{' '}
                                {minAnswersRequired} Fragen, um eine
                                aussagekraeftige Empfehlung zu erhalten.
                            </p>
                        </div>
                        <button
