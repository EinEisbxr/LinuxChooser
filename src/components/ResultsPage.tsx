...
export default function ResultsPage() {
    ...
    const { results, fullResults, warnings, dealBreakerWarnings, resetQuiz } =
        useQuiz();
    const [shareMessage, setShareMessage] = useState<string | null>(null);
    const [expandedAlternative, setExpandedAlternative] = useState<
        string | null
    >(null);
    ...
    const topFullResult =
        !isSharedView && fullResults.length > 0 ? fullResults[0] : null;
    ...
    const copyToClipboard = (text: string) => {
        navigator.clipboard
            ...
            .catch(() => {
                setShareMessage(
                    'Fehler: Zugriff auf die Zwischenablage verweigert',
                );
                setTimeout(() => setShareMessage(null), 3000);
            });
    };
        ...
        return (
            <div className="results-page">
                <div className="no-results">
                    ...
                    <p>
                        Bitte beantworte zuerst die Fragen, um eine Empfehlung
                        zu erhalten.
                    </p>
                    <motion.button
            ...
            >
                ...
                >
                    ...
                    <div className="recommendation-header">
                        ...
                        {!topFullResult &&
                            getDistroById(topResult.distroId)?.logo && (
                                <img
                                    src={
                                        getDistroById(topResult.distroId)!.logo
                                    }
                        ...
                        <h1 className="recommendation-title">
                            {topResult.name}
                            <span className="recommendation-desktop">
                                mit {topResult.desktopName}
                            </span>
                        </h1>
                    </div>
                    <div className="recommendation-score">
                        <div
                            ...
                            role="img"
                            aria-label={`Übereinstimmung: ${topResult.score} Prozent`}
                        >
                ...
                {isSharedView && (
                    ...
                    >
                        <p>
                            Dies ist eine geteilte Empfehlung. Mache den Quiz
                            selbst, um deine persönliche Empfehlung zu erhalten!
                        </p>
                        <motion.button
                ...
                >
                    ...
                    <div className="rankings-list">
                        {remainingResults.map((result, index) => {
                            ...
                            const altDownloadUrl = getDownloadUrl(
                                result.distroId,
                            );
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <div className="ranking-info">
                                            ...
                                            <span className="ranking-desktop">
                                                {result.desktopName}
                                            </span>
                                        </div>
