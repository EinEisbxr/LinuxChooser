...
export const problematicGames: Game[] = [
    {
        ...
        workaround:
            'Dual-Boot mit Windows oder Cloud-Gaming (GeForce NOW, Shadow).',
        warnings: [
    ...
    },
    {
        ...
        howToPlay: 'Nicht möglich auf Linux',
        workaround:
            'Dual-Boot mit Windows, Cloud-Gaming (GeForce NOW, Xbox Cloud) oder Android-Version.',
        warnings: ['Epic weigert sich trotz technischer Möglichkeit'],
    ...
    },
    {
        ...
        workaround:
            'Dual-Boot mit Windows (sicher) oder GeForce NOW (offiziell unterstützt).',
        warnings: [
    ...
    },
    {
        ...
        howToPlay: 'Nicht möglich auf Linux',
        workaround:
            'Dual-Boot mit Windows oder ältere FIFA-Titel (vor EA FC) prüfen.',
    ...
    },
    {
        ...
        howToPlay: 'Nicht möglich auf Linux',
        workaround:
            'Dual-Boot mit Windows, Android-Version, oder "Sober" (Android-Port für Linux).',
        category: 'sandbox',
        isPopular: true,
    },
];
...
export const partialGames: Game[] = [
    {
        ...
        howToPlay:
            'Via Wine oder Proton 10 mit Hoyoplay Launcher spielbar (inoffiziell)',
        workaround:
            'Proton 10 + Hoyoplay Launcher verwenden. Auf eigenes Risiko, da nicht offiziell unterstützt.',
    ...
    },
    {
        ...
        workaround:
            'Singleplayer: "-nobattleye" in Steam-Startoptionen. Proton Experimental verwenden. Online: Dual-Boot erforderlich.',
        warnings: ['GTA Online funktioniert NICHT auf Linux'],
    ...
    },
    {
        ...
        howToPlay:
            'Offline-Modi via Proton (Training, Situations, Custom Games)',
        workaround:
            'Training Grounds, Situations, Shooting Range funktionieren. Für Online: Dual-Boot erforderlich.',
        warnings: ['Kein Online-Multiplayer möglich'],
...
export const workingGames: Game[] = [
    ...
    },
    {
        ...
        workaround:
            '"--launcher-skip" für schnelleren Start. FSR2 Quality für Steam Deck empfohlen.',
    ...
    },
    {
        ...
        workaround:
            'Steam Deck: Native Version nutzen. Desktop Linux: Windows-Version via Proton.',
    ...
    },
    {
        ...
        workaround:
            'FSR2 Quality mit max Schärfe aktivieren. Auf 30 FPS sperren für Stabilität (Steam Deck).',
        warnings: [
    ...
    },
    {
        ...
        workaround:
            'Steam-Version: Einfach Proton aktivieren. Battle.net: Als Non-Steam-Game hinzufügen, GE-Proton 7-39+ verwenden.',
        category: 'fps',
        isPopular: true,
    },
    {
...
export function getGamesThatDontWork(): Game[] {
    return allGames.filter(
        (g) => g.status === 'anticheat' || g.status === 'broken',
    );
}
...
export const antiCheatInfo = {
    kernelLevel: {
        description:
            'Kernel-Level Anti-Cheat erfordert direkten Zugriff auf den Windows-Kernel und funktioniert nicht mit Linux, Proton oder Wine.',
        examples: [
    ...
    linuxCompatible: {
        description:
            'Diese Anti-Cheat-Systeme können mit Linux funktionieren, wenn der Entwickler sie aktiviert.',
        examples: [
