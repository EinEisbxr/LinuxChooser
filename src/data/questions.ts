...
export const questions: Question[] = [
    // Experience Level
    {
        ...
        options: [
            ...
            },
            {
                ...
                text: 'Einsteiger',
                description:
                    'Ich habe es mal ausprobiert oder in einer VM getestet',
                icon: 'leaf',
            },
            {
                id: 'intermediate',
                ...
                description:
                    'Ich nutze Linux regelmäßig und kenne die Grundlagen',
                icon: 'tree',
            },
            {
                id: 'advanced',
                text: 'Erfahren',
                description:
                    'Ich bin mit der Kommandozeile (Textbefehle) vertraut und habe mehrere Distros getestet',
                icon: 'mountain',
            },
            {
                id: 'expert',
    ...
    // Secondary Uses
    {
        ...
        options: [
            ...
            {
                id: 'streaming',
                text: 'Streaming und Videos erstellen',
                icon: 'video',
            },
    ...
    // Desktop Preference - Style
    {
        ...
        options: [
            ...
            },
            {
                ...
                description:
                    'Tastatur-fokussiert, effiziente Bildschirmnutzung',
                icon: 'grid',
            },
            {
                id: 'flexible',
    ...
    // Software Requirements
    {
        ...
        options: [
            ...
            {
                id: 'specific-windows',
                text: 'Andere Windows-Software',
                icon: 'windows',
            },
            {
                id: 'none',
                text: 'Keine davon / Open Source ist OK',
                icon: 'check',
            },
        ],
    },
